...
function ParticleBackground() {
  ...
  useEffect(() => {
    if (window.innerWidth < CFG.mobileBreak) return; // disabled on mobile, same as before
    ...
    function handleTouchMove(e) { mouse.x = e.touches[0].clientX; mouse.y = e.touches[0].clientY; }
    function handleTouchEnd() { mouse.x = null; mouse.y = null; }
